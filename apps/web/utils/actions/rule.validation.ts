...
const zodAction = z
  .object({
    ...
    readAttachments: z.boolean().nullish(),
    url: zodField,
    folderName: zodField,
    folderId: zodField,
...
export const enableLearnedPatternsBody = z.object({ enable: z.boolean() });
export type EnableLearnedPatternsBody = z.infer<
  typeof enableLearnedPatternsBody
>;
