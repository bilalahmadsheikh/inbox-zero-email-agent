...
function getEmailCapabilitiesPolicy({
  ...
  const enabledEmailSendingLines = [
    ...
    "- Recurring follow-up reminders: set repeatEveryMinutes and repeatCount (total sends) together with sendAt on sendEmail or replyEmail. The queue resends automatically until repeatCount sends have gone out.",
