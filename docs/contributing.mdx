---
title: 'Contributing'
description: 'Set up The Inbox Intern for local development'
---

This guide is for developers who want to run The Inbox Intern locally and contribute to the project.

<iframe
  width="560"
  height="315"
  src="https://www.youtube.com/embed/hVQENQ4WT2Y"
  title="Set up The Inbox Intern locally"
  frameBorder="0"
...
View open tasks in the issue tracker and join the support to discuss what's being worked on.
