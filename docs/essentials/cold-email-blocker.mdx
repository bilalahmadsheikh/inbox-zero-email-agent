...
To use the Cold Email Blocker, visit [this link](/cold-email-blocker).
...
If a sender has emailed you before, they are automatically excluded â€” the AI won't run on those emails.
