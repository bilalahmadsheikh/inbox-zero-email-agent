...
Add a delayed action to any rule in [AI Personal Assistant](/automation). When an email matches the rule, the action will be performed after the delay you specify.

**Common use cases:**

- **Auto-archive newsletters** after 7 days â€” they're still searchable if you need them later
