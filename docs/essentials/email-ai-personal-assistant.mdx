...
The AI Personal Assistant automatically manages your inbox â€” labeling, archiving, and drafting replies based on rules you define. Set it up using the [AI Chat](/essentials/ai-chat) or configure rules manually below.
...
To set up AI Personal Assistant for your email, click on the `AI Personal Assistant` tab in the left sidebar. Or visit [this link](/automation).
...
You can also create and manage rules through the [AI Chat](/essentials/ai-chat) â€” just describe what you want in plain English.

## Rules

On the [Rules](/automation?tab=rules) page, you can view and edit your rules.
...
When "Apply to Threads" is disabled on a rule, that rule is skipped for replies and only runs on the first email in a conversation. This is useful for rules that target standalone emails like newsletters or receipts â€” disabling it means the AI evaluates fewer rules on threaded emails, improving speed and accuracy.
...
You can test your rules by going to the [Test](/automation?tab=test) tab.
