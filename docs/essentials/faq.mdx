...
Answers to common questions about The Inbox Intern.
...
To add more email addresses to your account, please visit the [Settings](/settings) page in the left sidebar.
Then in the `Share Premium`, add the emails you'd like to share your premium with.
Each email address you add must first sign up to The Inbox Intern, and then you can add them to your account.
...
- Search for `The Inbox Intern`, click on it, and then click `See Details`
...
- Find `The Inbox Intern` in the list and click on it
- Click `Remove` to revoke access

If you don't see `The Inbox Intern` in the list, it means the account is not connected to The Inbox Intern.
...
1. **Use the [Inbox Intern Tabs Extension](/essentials/inbox-zero-tabs-extension)** - Our free browser extension adds custom tabs to Gmail, letting you organize emails by type (newsletters, receipts, to reply, etc.). It works great with our AI assistant which can automatically label emails for the tabs.

   ![Inbox Intern Tabs Extension](/images/extension.png)

2. **Use Gmail's Multiple Inboxes feature**:
   - Go to Gmail Settings â†’ "See all settings" â†’ "Inbox" tab
...
To delete your account, please visit the [Settings](/settings) page in the left sidebar.
Then in the `Delete Account` section, click on the `Delete Account` button.

### How do I cancel my subscription?

To cancel your subscription, please visit the [Settings](/premium) page in the left sidebar.
