...
Connect your Slack workspace to The Inbox Intern to receive notifications and interact with your AI email assistant directly from Slack. You can get meeting briefings delivered to a channel, receive auto-filing notifications, and chat with the AI by sending it a direct message or @mentioning it.

<Warning>
**AI disclaimer.** The Inbox Intern is powered by AI and may produce inaccurate outputs. Review all AI-generated content before acting. The Inbox Intern requests approval before sending replies or taking other high-impact actions in your inbox or Slack workspace.
</Warning>

## Connecting Slack

The "Add to Slack" button lives inside your The Inbox Intern account, so you'll install the app from the Channels page.

1. Sign up for a free The Inbox Intern account at [The Inbox Intern](/) and connect your Gmail or Outlook email account
2. Click **Channels** in the left sidebar
3. Find Slack in the list and click **Connect**
4. Authorize The Inbox Intern in the Slack OAuth flow (Slack will show the requested permissions and an **Allow** button)
...
You can interact with your The Inbox Intern AI assistant directly in Slack:

- **Direct message** the Inbox Intern bot to start a conversation
...
To disconnect Slack:
1. Go to **Channels** in the left sidebar
2. Click the menu (â‹®) next to your Slack workspace and choose **Disconnect Slack**
