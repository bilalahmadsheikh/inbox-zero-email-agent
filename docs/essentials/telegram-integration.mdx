...
Connect Telegram to The Inbox Intern to chat with your AI email assistant directly from Telegram. Ask questions about your inbox, draft emails, manage rules, and more â€” all from a Telegram DM.
...
4. Open a direct message with the Inbox Intern bot in Telegram
...
- `/connect` â€” Link your The Inbox Intern account
- `/switch` â€” Switch between email accounts
- `/summary` â€” Get an inbox summary
- `/draftreply` â€” Draft a reply to a recent email
- `/followups` â€” See emails awaiting replies
- `/cleanup` â€” Clean up old messages
