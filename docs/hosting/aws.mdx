...
description: 'Choose the right AWS deployment method for The Inbox Intern'
---

There are three ways to deploy The Inbox Intern on AWS. Choose the one that fits your team and infrastructure.
