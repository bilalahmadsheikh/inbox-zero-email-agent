...
description: 'Deploy The Inbox Intern on AWS EC2 with ALB'
---

This guide covers setting up The Inbox Intern on AWS EC2 with an Application Load Balancer.
...
2.  **Create Target Group:**
    *   Go to **EC2 Console** â†’ **Target Groups** â†’ **Create target group**
...
3.  **Create Application Load Balancer:**
    ...
    *   **Listeners:**
        *   Add listener: **HTTPS (443)** â†’ Forward to your target group
        *   (Optional) Add listener: **HTTP (80)** â†’ Redirect to HTTPS
...
4.  **Update DNS:**
    ...
    *   Find the ALB DNS name in **EC2 Console** â†’ **Load Balancers** â†’ click your ALB â†’ copy the **DNS name**
...
5.  **Update Security Group:**
    ...
    *   Add a new port 3000 rule with source set to the ALB's security group (find it in ALB â†’ Security tab)
