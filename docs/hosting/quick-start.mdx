---
title: 'Quick Start'
description: 'Self-host The Inbox Intern in under 5 minutes'
---

The fastest way to self-host The Inbox Intern is with two commands:
...
Need to remove The Inbox Intern or start fresh? See the [full cleanup guide](/hosting/troubleshooting#uninstalling--starting-over) in Troubleshooting.
