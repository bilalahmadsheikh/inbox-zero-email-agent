...
The Inbox Intern supports SAML SSO and SCIM user provisioning for organization deployments.

<Info>
  If you use the hosted The Inbox Intern cloud platform, contact sales to enable SSO or SCIM for your organization. If you self-host The Inbox Intern, an app admin configures SSO and SCIM from the admin page.
</Info>

## When to Use This

Use SSO and SCIM when your organization wants to manage The Inbox Intern access through an identity provider such as Okta, Microsoft Entra ID, or Google Workspace.
...
- A deployed The Inbox Intern instance with a stable `NEXT_PUBLIC_BASE_URL`.
