...
**Bot Token Scopes** â€” add these scopes:
...
3. Under **Subscribe to bot events**, add:
   ...
   - `app_mention` â€” @mentions in channels
   - `assistant_thread_started` â€” initialize Slack assistant thread prompts
   - `assistant_thread_context_changed` â€” respond to assistant context switches
