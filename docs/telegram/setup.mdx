...
description: "Set up the Telegram bot for The Inbox Intern assistant chat."
---

# Telegram Integration Setup

This guide is for self-hosted deployments that want to enable Telegram chat with the The Inbox Intern assistant.
...
4. Copy the bot token BotFather returns â€” this is your `TELEGRAM_BOT_TOKEN`

## 2. Configure the webhook

Set your bot's webhook to The Inbox Intern:
...
## 5. Connect a user account from The Inbox Intern

Each The Inbox Intern email account links to a Telegram user via a connect code:
